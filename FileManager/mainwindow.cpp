...
MainWindow::MainWindow()
{
    ...
    horizontalLayoutThird->addWidget(sortComboBox);
        ...
        /*
                fifth, sixth, seventh and eight layout will be contain in the hidebox
        */
        ...
        QMainWindow::setMaximumHeight(145);
...
void MainWindow::more()
{
        ...
        if(!toogle)
        {
                QMainWindow::setMaximumHeight(1600);
        hideBox->show();
